...
export default function(){
   ...
   function onsubmit(e){
    ...
    <h2 className='text-center'>Register</h2>
        ...
        <input type="password" className="form-control" value={password} pattern='(?=.*\d).{6,}' title='Must Contain Atleast 6 letters' onChange={e=>setPassword(e.target.value)} id="exampleInputPassword1"/>
        </div>
